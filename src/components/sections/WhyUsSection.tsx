      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div className="text-center mb-16 text-white">
          <div className="inline-block animate-fade-in-down">
            <span className="inline-block text-lg font-semibold uppercase tracking-wider bg-gradient-to-r from-blue-500/20 to-purple-500/20 text-white px-6 py-3 rounded-2xl backdrop-blur-md border border-blue-500/40 shadow-lg animate-pulse-glow relative overflow-hidden group">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {advantages.map((advantage, index) => (
            ...
            >
              <div className="relative h-full bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 shadow-2xl transition-all duration-500 transform hover:scale-105 hover:bg-white/15 hover:shadow-[0_0_30px_rgba(255,255,255,0.15)] overflow-hidden">
