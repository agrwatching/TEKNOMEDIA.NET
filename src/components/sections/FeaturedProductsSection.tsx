...
const PortalBeritaSection = ({ limit, showViewAll = false }: PortalBeritaSectionProps) => {
      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-800 mt-4">
            Menampilkan {limit ? `${displayedPosts.length} dari ${posts.length}` : posts.length} artikel terbaru dari{" "}
        ...
        {showViewAll && limit && posts.length > limit && (
          <div className="text-center mt-12">
            <Link
              href="/berita"
              className="inline-flex items-center gap-2 px-8 py-4 bg-blue-600 text-white font-semibold rounded-full hover:bg-blue-700 transition-all shadow-lg hover:shadow-xl"
            >
              Lihat Semua Berita
              <ArrowRight className="w-5 h-5" />
            </Link>
