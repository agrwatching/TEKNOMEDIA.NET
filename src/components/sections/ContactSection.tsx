  ...
  return (
    <section id="contact" className="py-16 md:py-24 relative overflow-hidden bg-white">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {/* Gradient Orbs - Only 2 */}
        <div 
          className="absolute top-20 right-10 w-96 h-96 bg-gradient-to-br from-indigo-400/20 to-purple-400/20 rounded-full blur-3xl animate-pulse-slow" 
          style={{ willChange: 'opacity, transform' }}
        />
        <div 
          className="absolute bottom-20 left-10 w-80 h-80 bg-gradient-to-br from-blue-400/20 to-cyan-400/20 rounded-full blur-3xl animate-pulse-slow" 
            ...
            <div className="relative bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 rounded-2xl p-6 shadow-xl overflow-hidden animate-fade-in-left" style={{ animationDelay: '0.4s' }}>
              ...
              <div className="relative z-10">
                ...
                <div className="flex gap-3">
                  <a href="#" className="w-12 h-12 bg-white/10 hover:bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center transition-all hover:scale-110 hover:rotate-12 border border-white/20">
                ...
                <div className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="group">
                      ...
                      <input
                        ...
                        required
                        className="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all group-hover:border-gray-300 text-gray-900"
                  ...
                  <div className="group">
                    ...
                    <textarea
                      ...
                      required
                      rows={6}
                      className="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all resize-none group-hover:border-gray-300 text-gray-900"
                  ...
                  >
                    ...
                    {isSubmitting ? (
                      ...
                      <>
                        ...
                        <Sparkles size={18} className="ml-2 relative z-10" />
                      </>
                    )}
                  </button>
                </div>
